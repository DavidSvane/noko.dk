...
function textEditorCleanUp() {
  ...
  $('.editor').each(function() {
    ...
    $.post('http://noko.dk/server/mysql.php', {update_content: 'text', text: new_text, id: new_id, l: new_lang}, function (data) {
...
$('img').dblclick(function() {
  ...
  $.post('php/img_selector.php', function (data) {
    ...
    $('.img_selector img').click(function() {
      ...
      $.post('http://noko.dk/server/mysql.php', {update_content: 'img', id: img_id, src: new_src}, function (data) {
