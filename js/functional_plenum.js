...
function pollClose(e) {
  ...
  $.post('http://noko.dk/server/db.php', {page: 'poll_close', p: pid, nr: localStorage.getItem('user')}, function (data) {
...
function pollOpen(e) {
  ...
  $.post('http://noko.dk/server/db.php', {page: 'poll_open', t: e, q: data, nr: localStorage.getItem('user')}, function (data) {
...
function pollReopen(vid) {
  ...
  $.post('http://noko.dk/server/db.php', {page: 'poll_reopen', id: vid, nr: localStorage.getItem('user')}, function (data) {
...
function pollCloseAll() {
  ...
  $.post('http://noko.dk/server/db.php', {page: 'poll_close_all', nr: localStorage.getItem('user')}, function (data) {
...
function pollResult(e) {
  ...
  $.post('http://noko.dk/server/db.php', {page: 'poll_result', id: e, nr: localStorage.getItem('user')}, function (data) {
